...
For  
\[
\mathbf r(t)=\bigl(\cos t,\sin t,t\bigr):
\]
...
1. \[
   \mathbf r(t)=e^{t}\cos t\,\hat{\imath}
   +e^{t}\sin t\,\hat{\jmath}
   \]
2. \[
   \mathbf r(t)=2\cos t\,\hat{\imath}
   +3\sin t\,\hat{\jmath},
...
\[
w=x^{2}+y^{2}+z^{2},\quad
x=\sin\theta,\;y=\cos\theta,\;z=\tan\theta,
\]
...
* \(f(x,y)=2y-\frac{y^{2}}{7}, \; -\pi\le x\le\pi,\;0\le y\le2\)  
...
2. \[
   \iint_{R} xy\,dA,
   \quad R:\;0\le x\le1,\;0\le y\le1,\;x+y\le1
   \]
